...
/// </summary>
public static class Hp67CardProgramFormat
{
  public const string Header = "HP67";

  public static string Format(
    Hp67CardSnapshot snapshot,
    Func<byte, string> mnemonicForCode)
  {
    ...
    sb.Append("DATA\r\n");
    int registerCount = Math.Max(Hp67CardSnapshot.DefaultRegisterCount, snapshot.Registers.Count);
    ...
    {
      Hp67CardModeSnapshot mode = snapshot.Mode;
      sb.Append("MODE ")
  ...
  public static Hp67CardSnapshot Parse(
    string text,
    Func<string, byte?> codeForMnemonic,
    int programCapacity = Hp67CardSnapshot.DefaultProgramCapacity,
    int registerCount = Hp67CardSnapshot.DefaultRegisterCount)
  {
    ...
    return new Hp67CardSnapshot(program, registers, mode);
  }
  ...
  public static Hp67CardSnapshot ReadFile(
    string path,
    Func<string, byte?> codeForMnemonic,
    int programCapacity = Hp67CardSnapshot.DefaultProgramCapacity,
    int registerCount = Hp67CardSnapshot.DefaultRegisterCount)
  ...
  private static Hp67CardModeSnapshot ParseMode(string[] tokens)
  {
    if (tokens.Length < 8)
    {
    ...
    return new Hp67CardModeSnapshot(tokens[1], tokens[2], digits & 0xF, flagsHi, flagsLo);
  }
