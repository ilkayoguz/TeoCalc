...
public static class ClassicFaceplateSvgAssets
{
  ...
  private static string LegacyKeyCapPath(CalcButtonStyle style)
  {
    string file = style switch
    {
      ...
      CalcButtonStyle.LightGrey => "KeyCap-grey.svg",
      CalcButtonStyle.Cement => "KeyCap-grey.svg",
      CalcButtonStyle.DarkGrey => "KeyCap-black.svg",
