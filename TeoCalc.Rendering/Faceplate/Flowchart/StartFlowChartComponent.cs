...
public sealed class StartFlowChartComponent : FlowChartComponentBase
{
  private static readonly uint Fill = 0xFF3A4A42u;

  public StartFlowChartComponent(StudioFlowchartGraph.Node node)
    : base(node)
  {
  }
