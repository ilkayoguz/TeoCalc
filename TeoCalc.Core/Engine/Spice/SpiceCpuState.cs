...
public sealed class SpiceCpuState
{
  ...
  public SpiceCpuFlags Flags { get; set; }

  public SpiceInstructionState InstructionState { get; set; }
  ...
  public SpiceRegisterFile Registers { get; } = new();
  ...
  public void Reset()
  {
    ProgramCounter = 0;
    DelRom = 0;
    Flags = SpiceCpuFlags.None;
    InstructionState = SpiceInstructionState.Norm;
    ReturnStack[0] = 0;
    ReturnStack[1] = 0;
    StackPointer = 0;
    P = 0;
