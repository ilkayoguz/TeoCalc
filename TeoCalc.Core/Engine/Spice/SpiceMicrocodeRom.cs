...
/// <summary>Spice-family firmware ROM (little-endian ushort image).</summary>
public sealed class SpiceMicrocodeRom
{
  private readonly ushort[] _words;

  public SpiceMicrocodeRom(ushort[] words)
  {
    _words = words;
  }
  ...
  public static SpiceMicrocodeRom LoadBinary(string path)
  {
    ...
    return new SpiceMicrocodeRom(words);
  }
}
