...
public static class SpiceFirmwareDisplay
{
  ...
  public static string BuildLedText(SpiceCpuState state)
  {
    if ((state.Flags & SpiceCpuFlags.DisplayOn) == 0)
    {
      return string.Empty;
    }
  ...
  public static string ToLedFontText(SpiceCpuState state) =>
