...
public sealed class Hp01CpuState
{
  ...
  public Hp01CpuFlags Flags { get; set; }
  public Hp01ExtraFlags ExtraFlags { get; set; }
  ...
  public void Reset()
  {
    ...
    Opcode = 0;
    Status = 0;
    Flags = Hp01CpuFlags.None;
    ExtraFlags = Hp01ExtraFlags.None;
    Rom = 0;
    KeyBuffer = 0;
    TickCnt = 0;
    LastOpcode = 0;
