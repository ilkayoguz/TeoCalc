...
namespace TeoCalc.Core.Engine.Hp67;
...
/// </summary>
public static class Hp67CardProgramIo
{
  ...
  public static Hp67CardMode ExportMode(ActCpuState state)
  {
    ArgumentNullException.ThrowIfNull(state);
  ...
  public static void ImportMode(ActCpuState state, Hp67CardMode mode)
  {
    ArgumentNullException.ThrowIfNull(state);
...
public sealed record Hp67CardMode(
  string Angle,
  string Display,
  int Digits,
  byte FlagsHi,
