...
public sealed class PanamatikFormEngine : IPanamatikEngine
{
  private readonly Form _form;
  private readonly Type _formType;

  public PanamatikFormEngine(string modelId, string modelDirectory, Type formType)
  {
    ModelId = modelId;
    _formType = formType;
  ...
  private T Invoke<T>(string methodName)
  {
    ...
    return (T)method.Invoke(_form, null)!;
  }
}
