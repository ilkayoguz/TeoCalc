...
public sealed class Teo19CFaceplateLegendTests
{
  ...
  {
    ProgramVocabulary vocabulary = LoadVocabulary();
    KeyLegendVisual xExchange = ClassicKeyFaceplateLegend.Resolve(
    ...
    KeyLegendVisual roll = ClassicKeyFaceplateLegend.Resolve(
    ...
    KeyLegendVisual nine = ClassicKeyFaceplateLegend.Resolve(
    ...
    KeyLegendVisual gto = ClassicKeyFaceplateLegend.Resolve(
    ...
    KeyLegendVisual sin = ClassicKeyFaceplateLegend.Resolve(
