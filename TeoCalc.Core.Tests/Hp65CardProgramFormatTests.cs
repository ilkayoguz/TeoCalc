...
[TestClass]
public sealed class Hp65CardProgramFormatTests
{
  ...
  public void RoundTrip_ProgramAndData_PreservesCodesAndRegisters()
  {
    ...
    byte[] codes = new byte[Hp65CardSnapshot.DefaultProgramCapacity];
    ...
    string text = Hp65CardProgramFormat.Format(
      new Hp65CardSnapshot(codes, registers),
    ...
    Hp65CardSnapshot parsed = Hp65CardProgramFormat.Parse(
      text,
